  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top text-white">
    <div class="container">
      <div class="navbar-wrapper">
        <a class="navbar-brand" href="index.php">Student Academic Descipline System</a>
      </div>
            ...
            <form class="form" action="functions/login.php" method="post">
              <div class="card card-login card-hidden">
                <div class="card-header card-header-success text-center">
                  <img src="assets/img/guidance logo.png" alt="..." class="img-just-icon" style="width: 120px;">
                ...
                <div class="card-body">
                  <p class="card-description text-center">
                    ...
                    if (isset($_SESSION['error_message'])) {
                      echo '<span style="color: red;">' . $_SESSION['error_message'] . '</span>'; // Display error message
                      unset($_SESSION['error_message']); // Remove the error message after it is displayed
                    } else {
                      echo "Enter your credentials"; // Default message
      ...
      <footer class="footer">
        <div class="container">
          <nav class="float-left">
            <ul>
              <li>
                <a href="https://www.facebook.com/profile.php?id=61567324790484">
                  Guidance Office
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#">
                  STUDENT ACADEMIC DISCIPLINE SYSTEM </a>
              </li>
          ...
          <div class="copyright float-right">
            ...
            <a href="https://www.creative-tim.com" target="_blank">Shunshine Mae Galvez | Thresheamae Reponte | Russel
              Rodrigo</a>.
          </div>
        </div>
      </footer>
